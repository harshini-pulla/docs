...
## GET /api/campaigns/:id/public-link

Returns the **public candidate self-application URL** generated using the campaign’s secure `publicApplyToken`.
...
```
{
  "success": true,
  "data": {
    "campaignId": "679aa3fa2150442ce4c34435",
    "publicApplyUrl": "https://yourdomain.com/apply/6e9cf1a0bde2"
  }
}
```